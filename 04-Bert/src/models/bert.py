...
class Config(object):
    def __init__(self):
        ...
        self.data_path = "E:/workspace/Phsproject/04-Bert/data/data1/"  # 数据集的根路径
        ...
        self.save_path = "E:/workspace/Phsproject/04-Bert/src/saved_dic"  # 模型训练结果保存路径
        if not os.path.exists(self.save_path):
            os.mkdir(self.save_path)
        self.save_path += "/" + self.model_name + ".pt"  # 模型训练结果

        self.save_path2 = "E:/workspace/Phsproject/04-Bert/src/saved_dic1"  # 量化模型存储结果路径
        ...
        self.bert_path = "E:/workspace/Phsproject/04-Bert/data/bert_pretrain"  # 预训练BERT模型的路径
