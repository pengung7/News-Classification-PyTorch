...
class Config(object):
    def __init__(self):
        ...
        self.data_path = "/workspace/Phsproject/05-bert_distil/data/data/" #数据集的根路径
        ...
        self.save_path = "/workspace/Phsproject/05-bert_distil/src/saved_dic" #模型训练结果保存路径
        ...
        self.bert_path = "/workspace/Phsproject/05-bert_distil/data/bert_pretrain" # 预训练BERT模型的路径
